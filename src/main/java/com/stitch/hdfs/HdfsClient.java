...
public class HdfsClient {
    ...
    public void testMkdirs() throws IOException, InterruptedException, URISyntaxException {
        ...
        // 2 创建目录
        fs.mkdirs(new Path("/ubuntu/output/NLine"));
        // 3 关闭资源
        fs.close();
    }
    ...
    public void testCopyFromLocalFile() throws IOException, InterruptedException, URISyntaxException {
        ...
        FileSystem fs = FileSystem.get(new URI("hdfs://150.158.174.69:9000"), configuration, "ubuntu");
        // 2 上传文件
        fs.copyFromLocalFile(new Path("e:/code_lwh/hadoop/NLineInputFormatExample/wordcount.txt"), new Path("/ubuntu/input/NLine/wordcount.txt"));
        // 3 关闭资源
        fs.close();
    ...
    public void getFileFromHDFS() throws IOException, InterruptedException, URISyntaxException{
        ...
        FileSystem fs = FileSystem.get(new
                URI("hdfs://150.158.174.69:9000"), configuration, "ubuntu");
        // 2 获取输入流
        FSDataInputStream fis = fs.open(new Path("/ubuntu/output/flownum/part-r-00000"));
        // 3 获取输出流
        FileOutputStream fos = new FileOutputStream(new File("e:/code_lwh/hadoop/MapreduceFlowsum/part.txt"));
        // 4 流的对拷
        IOUtils.copyBytes(fis, fos, configuration);
        // 5 关闭资源
        IOUtils.closeStream(fos);
